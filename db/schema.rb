...
ActiveRecord::Schema.define(version: 2019_10_28_160739) do
  ...
  create_table "spree_option_values", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.index ["user_id"], name: "index_spree_option_values_on_user_id"
  end
  ...
  create_table "spree_related_option_types", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.string "record_type", limit: 128, null: false
    t.integer "record_id", null: false
    t.integer "option_type_id", null: false
    t.integer "position", default: 1
    t.index ["position"], name: "index_spree_related_option_types_on_position"
    t.index ["record_type", "record_id"], name: "index_spree_related_option_types_on_record_type_and_record_id"
  end
