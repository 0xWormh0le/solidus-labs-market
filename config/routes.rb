Spree::Core::Engine.routes.draw do
  ...
  get '/api/option_types/:option_type_id/including_custom_option_values', to: 'spree/api/option_values#including_custom_index', as: :api_option_type_including_custom
  match '/related_option_types/:record_type/:record_id(.:format)' => 'api/option_types#related', as: :related_option_types, via: [:get, :put, :post]
  ...
  match '/checkout/update_all/:order_id', to: 'checkout#update_all', as: 'checkout_update_all', via: [:put, :post, :patch]
