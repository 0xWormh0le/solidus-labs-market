class Retail::Site < ::RetailScraperRecord
  ...
  has_many :scraper_runs, class_name: 'Scraper::Run', foreign_key: 'retail_site_id', dependent: :destroy
  alias_method :runs, :scraper_runs

  has_many :page_requests, class_name: 'Scraper::PageRequest', foreign_key: 'retail_site_id'
  has_many :pages, class_name: 'Scraper::Page', foreign_key: 'retail_site_id'

  has_many :retail_products, class_name: 'Retail::Product', foreign_key: 'retail_site_id', dependent: :destroy
  has_many :retail_stores, class_name: 'Retail::Store', foreign_key: 'retail_site_id', dependent: :destroy
