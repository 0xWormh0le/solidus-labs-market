module Spree
  module Admin
    ProductsController.class_eval do
      ...
      before_action :set_current_user_id, :set_to_save_currency_prices, only: [:create, :update, :clone]
      ...
      def permitted_price_attributes
        [:variant_id, :amount, :currency, :country_iso]
      end

      def permitted_product_attributes
        super + [ :shipping_category_id, price_attributes: permitted_price_attributes ]
      end
